...
extern "C" {
JNIEXPORT jboolean JNICALL Java_com_hellen_flower_service_Watcher_createWatcher(
		JNIEnv*, jobject, jstring);

JNIEXPORT jboolean JNICALL Java_com_hellen_flower_service_Watcher_connectToMonitor(
		JNIEnv*, jobject);

JNIEXPORT jint JNICALL Java_com_hellen_flower_service_Watcher_sendMsgToMonitor(
		JNIEnv*, jobject, jstring);
