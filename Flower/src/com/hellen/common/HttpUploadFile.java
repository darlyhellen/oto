...
public class HttpUploadFile {
	...
	public static String uploadFile(File file) {
		...
		try {
			URL url = new URL(ConsHttpUrl.EXCEPTIONUPLOAD);
			...
			if (file != null) {
				...
				sb.append("Content-Disposition: form-data; name=\"img\"; filename=\""
						+ SharePreferHelp.getValue(ConsMVP.TOKEN.getDec(), null)
	...
	public static String uploadFiles(String url, List<File> files) {
		try {
