 ...
 */
public class WholeListAdapter extends ParentAdapter<Bannar> {
	 ...
	 * @author zhangyh2
	 */
	public WholeListAdapter(List<Bannar> data, int resID, Context context) {
	...
	public View HockView(int position, View view, ViewGroup parent, int resID,
		...
		ImageLoaderUtil.getInstance().loadImageNor(t.getImgUrl(), hocker.iv);
		hocker.descrip.setText(t.getTitle());
		LogApp.i(TAG, t.getImgUrl()+""+t.getTitle());
		return view;
	}
