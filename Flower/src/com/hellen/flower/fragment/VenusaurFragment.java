...
import com.hellen.presenter.FragmentVenusaurPresenter;
 ...
 */
public class VenusaurFragment extends BaseFragment implements
		VenusaurInterface, OnClickListener, OnItemClickListener {
	...
	private FragmentVenusaurPresenter mainPresenter;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		rootView = inflater.inflate(R.layout.fragment_main_venusaur, container,
				false);
		return rootView;
	}
	...
	protected void initView(Bundle savedInstanceState) {
		// TODO Auto-generated method stub
		header = (LinearLayout) rootView.findViewById(R.id.ven_header);
		text = (LinearLayout) rootView.findViewById(R.id.ven_text);
		headerView = (HeaderView) rootView.findViewById(R.id.ven_headerview);
		tv = (TextView) rootView.findViewById(R.id.ven_tv);
		wlv = (WholeListView) rootView.findViewById(R.id.ven_wlv);
		...
		mainPresenter = new FragmentVenusaurPresenter(this, show);
	...
	protected void loadData() {
		// TODO Auto-generated method stub
		headerView.onSetTitle(R.string.venusaur);
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.hellen.biz.VenusaurInterface#isShowTitle(boolean)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.hellen.biz.VenusaurInterface#onSucces()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.hellen.biz.VenusaurInterface#onFaild()
	 */
	@Override
	public void onFaild() {
		// TODO Auto-generated method stub
	...
	public void onClick(View v) {
		...
		switch (v.getId()) {
		case R.id.ven_tv:
			LogApp.i(TAG, "R.id.ven_tv 准备跳入一组Fragment");
			((MainActivity) getActivity()).swichTo(R.id.main_footer_act);
			break;
