...
public class CircleMenuLayout extends ViewGroup {
	...
	public void setCenterImageRes(int resid) {
		ImageView iv = (ImageView) findViewById(R.id.id_circle_menu_item_center);
		if (iv != null && resid != 0) {
	...
	private void addMenuItems() {
		...
		for (int i = 0; i < mMenuItemCount; i++) {
			...
			if (tv != null) {
				...
				Drawable drawable = getResources().getDrawable(mItemImgs[i]);
