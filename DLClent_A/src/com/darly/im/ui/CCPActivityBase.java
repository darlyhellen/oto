...
import com.darly.im.common.AudioManagerTools;
import com.darly.im.common.base.CCPLayoutListenerView;
...
import com.darly.im.common.view.VerticalImageSpan;
...
public abstract class CCPActivityBase {
    ...
    public void init(Context context , FragmentActivity activity)  {
        ...
        if (layoutId != -1) {
            ...
            mRootView.addView(mContentView, LayoutParams.MATCH_PARENT,
                    LayoutParams.MATCH_PARENT);
        }
