...
import com.darly.im.common.utils.BitmapUtil;
import com.darly.im.common.utils.DemoUtils;
import com.darly.im.common.utils.DialNumberMap;
import com.darly.im.common.utils.ECPropertiesUtil;
...
import com.darly.im.core.ECArrayLists;
import com.darly.im.core.Phone;
import com.darly.im.core.comparator.PyComparator;
            ...
            if (cursor != null) {
                ...
                while (cursor.moveToNext()) {
                    ...
                    if (mimetype.equals(ContactsContract.CommonDataKinds.Phone.CONTENT_ITEM_TYPE)) {
                        Phone phone = null;
                        if (data2 == BaseTypes.TYPE_CUSTOM) {
...
//							char c = name.charAt(i);
    ...
    public static Bitmap getContactPhoto(ECContacts contact){
        ...
        if (photoId != 0) {
            ...
            try {
                cursor = contentResolver.query(ContactsContract.Data.CONTENT_URI, new String[] { BaseColumns._ID, ContactsContract.CommonDataKinds.Photo.PHOTO }, BaseColumns._ID + " = " + photoId, null, null);
