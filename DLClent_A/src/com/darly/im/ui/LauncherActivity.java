...
import com.darly.im.common.ECContentObservers;
import com.darly.im.common.base.CCPCustomViewPager;
import com.darly.im.common.base.CCPLauncherUITabView;
import com.darly.im.common.base.OverflowAdapter;
import com.darly.im.common.base.OverflowAdapter.OverflowItem;
import com.darly.im.common.base.OverflowHelper;
import com.darly.im.common.dialog.ECAlertDialog;
import com.darly.im.common.dialog.ECProgressDialog;
import com.darly.im.common.utils.CrashHandler;
...
import com.darly.im.ui.chatting.CustomerServiceHelper;
...
import com.darly.im.ui.contact.MobileContactSelectActivity;
import com.darly.im.ui.group.BaseSearch;
import com.darly.im.ui.group.CreateGroupActivity;
import com.darly.im.ui.group.ECDiscussionActivity;
import com.darly.im.ui.group.GroupNoticeActivity;
...
public class LauncherActivity extends ECFragmentActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (!APP.isNetworkConnected(this)) {
			...
			HttpClient.post(ConsHttpUrl.FRIEND, "",
					new RequestCallBack<String>() {
						...
						public void onSuccess(ResponseInfo<String> arg0) {
							...
							SharePreferCache.putValue(SharePreferHelp.getValue(APPEnum.USERVOIP.getDec(), null)+SharePreferCache.CACHE,
	...
	private void initWelcome() {
		if (!mInit) {
			...
			ECHandlerHelper.postDelayedRunnOnUI(initRunnable, 0);
		}
	}
	...
	private void initLauncherUIView() {
		...
		TextView tilt = (TextView) mLauncherView.findViewById(R.id.btn_middle);
		tilt.setText("会话记录");
		...
		findViewById(R.id.btn_plus_back).setOnClickListener(this);
	...
	private class LauncherViewPagerAdapter extends FragmentStatePagerAdapter
		...
		public void onPageScrolled(int position, float positionOffset,
			...
			if (positionOffset != 0.0F
					&& position == CCPLauncherUITabView.TAB_VIEW_THIRD) {
				if (mGroupListFragment == null) {
			...
			if (positionOffset != 0.0F
					&& position == CCPLauncherUITabView.TAB_VIEW_FOUR) {
	...
	private final AdapterView.OnItemClickListener mOverflowItemCliclListener = new AdapterView.OnItemClickListener() {
		...
		public void onItemClick(AdapterView<?> parent, View view, int position,
			...
			if (getString(R.string.main_plus_groupchat).equals(title)) {
				...
				// 关闭设置进入口
				// } else if
				// (getString(R.string.main_plus_settings).equals(title)) {
				// // 设置;
				// startActivity(new Intent(LauncherActivity.this,
