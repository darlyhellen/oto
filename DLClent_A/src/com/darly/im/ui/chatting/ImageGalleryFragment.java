...
import com.darly.im.photoview.PhotoView;
import com.darly.im.photoview.PhotoViewAttacher;
...
public class ImageGalleryFragment extends CCPFragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
		...
		if(msg!=null&&msg.getDirection()==Direction.RECEIVE&&ImageGralleryPagerActivity.isFireMsg&&isFireMsg&&!CCPAppManager.getUserId().equalsIgnoreCase(msg.getForm())){
