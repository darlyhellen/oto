 ...
 */
package com.darly.im.ui.chatting.view;
...
import com.darly.im.common.base.CCPDotView;
import com.darly.im.common.base.CCPFlipper;
import com.darly.im.common.utils.DensityUtil;
import com.darly.im.common.utils.LogUtil;
import com.darly.im.ui.chatting.AppPanelControl;
...
public class AppPanel extends LinearLayout implements CCPFlipper.OnFlipperPageListener
	...
	/**
	 * width of {@link com.darly.im.ui.chatting.view.AppPanel} {@link AppGrid}
	 */
	private int mGridWidth;
	
	/**
	 * height of {@link com.darly.im.ui.chatting.view.AppPanel} {@link AppGrid}
	 */
	...
	private void initAppPanel() {
		mPanelLayoutParams = new LayoutParams(android.view.ViewGroup.LayoutParams.FILL_PARENT , android.view.ViewGroup.LayoutParams.WRAP_CONTENT);
