...
public class ContactSqlManager extends AbstractSQLManager {
    ...
    public static ECContacts getContact(long rawId) {
        ...
        try {
            Cursor cursor = getInstance().sqliteDB().query(DatabaseHelper.TABLES_NAME_CONTACT, new String[]{BaseColumn.ID,ContactsColumn.USERNAME ,ContactsColumn.CONTACT_ID ,ContactsColumn.REMARK},
