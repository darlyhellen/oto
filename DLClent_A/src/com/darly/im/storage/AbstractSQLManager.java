...
public abstract class AbstractSQLManager {
	...
	public AbstractSQLManager() {
		openDatabase(APP.getInstance(), CCPAppManager.getVersionCode());
	}
		...
		if (databaseHelper == null) {
			if (SharePreferHelp.getValue(APPEnum.USERINFO.getDec(), null) != null) {
				...
				if (data != null && data.getData() != null) {
					databaseHelper = new DatabaseHelper(context, this, data
							.getData().getVoipAccount()
							+ "_"
	...
	static class DatabaseHelper extends SQLiteOpenHelper {
		...
		public DatabaseHelper(Context context, AbstractSQLManager manager,
				int version) {
			this(context, manager, CCPAppManager.getClientUser().getUserId()
					+ "_" + DATABASE_NAME, null, version);
		}
		...
		private void onAddHistoryTable(SQLiteDatabase db) {
			String sql = "CREATE TABLE IF NOT EXISTS "
					+ TABLES_NAME_IM_MESSAGE_HISTORY + " (" + BaseColumn.ID
		...
		void createTableGroupMembers(SQLiteDatabase db) {
			String sql = "CREATE TABLE IF NOT EXISTS "
					+ TABLES_NAME_GROUP_MEMBERS + " (" + BaseColumn.ID
					+ " INTEGER PRIMARY KEY AUTOINCREMENT, "
