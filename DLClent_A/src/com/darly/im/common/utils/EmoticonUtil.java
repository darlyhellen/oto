...
import com.darly.im.ui.chatting.base.EmojiconHandler;
import com.darly.im.ui.chatting.base.emoji.Emojicon;
import com.darly.im.ui.chatting.base.emoji.People;
import com.darly.im.ui.chatting.model.CCPEmoji;
	...
	public static void initEmoji() {
		...
		for(Emojicon emojicon:data) {
			if(emojicon.getEmoji() != null) {
				...
				if(unicode > 0xff) {
					emoji.setId(EmojiconHandler.getEmojiResource(APP.getInstance().getApplicationContext(), unicode));
					emojis.add(emoji);
				}
			}
		}
