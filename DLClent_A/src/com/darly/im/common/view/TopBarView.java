...
/**
 * ECDemo 顶部导航 Created by Jorstin on 2015/3/17.
 */
public class TopBarView extends LinearLayout {
	...
	private void initView() {
		...
		setBackgroundResource(R.color.app_main_header_bg);
		// setBackgroundDrawable(new
		// ColorDrawable(mContext.getResources().getColor(R.color.app_main_header_bg)));
