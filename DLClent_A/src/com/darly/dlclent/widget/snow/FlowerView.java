package com.darly.dlclent.widget.snow;
...
/**
 * @ClassName: FlowerView
 * @Description: TODO(雪花效果)
 * @author 张宇辉 zhangyuhui@octmami.com
 * @date 2015年1月26日 下午5:36:35
 *
 */
public class FlowerView extends View {

	Bitmap mFlowers = null;
	MyFlower[] flowers = null;
	...
	public void loadFlower(int resID) {
		Drawable drawable = this.getContext().getResources().getDrawable(resID);
		if (drawable == null) {
			mFlowers = ((BitmapDrawable) this.getContext().getResources()
					.getDrawable(R.drawable.personal_msg_tab_background)).getBitmap();
		} else {
