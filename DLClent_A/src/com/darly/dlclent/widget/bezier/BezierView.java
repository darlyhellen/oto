package com.darly.dlclent.widget.bezier;
...
/**
 * Created by chenupt@gmail.com on 11/20/14. Description : custom layout to draw
 * bezier
 */
public class BezierView extends FrameLayout {
	...
	private void init() {
		...
		tipImageView
				.setImageResource(R.drawable.skin_tips_newmessage_ninetynine);
